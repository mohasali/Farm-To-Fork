<x-layout>
  <main class="w-full">
    ...
    <section class="w-full h-830px">
      ...
      <section>
        <div class="w-full h-[100px] flex flex-col items-center justify-center">
          <h1 class="text-5xl font-bold text-primary mb-2">Find a local farm</h1>
        </div>
      </section>
      <section class=" w-full h-300px bg-gray-200 shadow-md">
      <div class="w-3/4 lg:w-1/2 p-5 flex items-center justify-center">
      <div class="bg-gray-200 rounded-2xl w-full md:w-3/4 lg:p-10 p-4">
      </section>
      <!-- Header - Our Location -->
      <section class="w-full h-800px bg-white mb-12">
      <section>
        <div class="w-full h-[100px] flex flex-col items-center justify-center">
          <h1 class="text-5xl font-bold text-secondary mb-2">Our location</h1>
        </div>
      </section>
      <!-- Google Maps -->
      <section>
