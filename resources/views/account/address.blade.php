<x-account-layout>
    ...
    <div class="flex flex-wrap items-stretch gap-4 max-h-[600px] overflow-y-auto">
        <!-- Add address -->
        <button class="flex flex-col bg-gray-100 py-4 rounded-xl justify-center items-center w-full sm:w-[100%] h-[275px]">
            <p class="text-2xl mb-1" style="opacity: 0.75;">+</p>
            <p class="text-2xl">Add Address</p>
        </button>
        <!-- Current address -->
        <div class="flex flex-col bg-gray-100 py-4 rounded-xl justify-start items-start w-full sm:w-[100%] h-[275px]">
            ...
            <div class="flex flex-row mt-auto space-x-4 ml-auto mr-4">
