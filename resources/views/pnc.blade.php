<x-layout title="Terms and Conditions">
    ...
    <div class="container mx-auto p-4 md:p-8">
        <div class="w-full md:w-2/3 mx-auto text-left mb-12">
            <!-- Cookies Policy -->
            <h1 class="text-gray-1000 text-3xl md:text-5xl font-bold mt-8">Cookies Policy</h1>
            ...
            <h4 class="text-lg md:text-2xl">Interpretation</h4>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <!-- Definitions -->
            <h4 class="text-black text-xl md:text-3xl font-bold mt-8">Definitions</h4>
            <p class="text-lg md:text-2xl">For the purposes of this Cookies Policy:</p>
            <ul>
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Farm to Fork.</li>
                <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                <li><strong>Website</strong> refers to Farm to Fork, accessible from <a href="http://farm-to-fork.test/" rel="external nofollow noopener" target="_blank">http://farm-to-fork.test/</a></li>
                <li><strong>You</strong> means the individual accessing or using the Website, or a company, or any legal entity on behalf of which such individual is accessing or using the Website, as applicable.</li>
            </ul>
            <!-- The use of the Cookies -->
            <h4 class="text-black text-xl md:text-3xl font-bold mt-8">The use of the Cookies</h4>
            <h4 class="text-lg md:text-2xl">Type of Cookies We Use</h4>
            ...
            <h4 class="text-black text-xl md:text-3xl font-bold mt-8">Your Choices Regarding Cookies</h4>
